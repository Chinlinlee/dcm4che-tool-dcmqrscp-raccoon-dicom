...
The modify version that support:
- Use raccoon local uploader script instead of original storage method
- Connect to raccoon's mongodb to find and move 
...
Options:
 ...
 -h,--help                              display this help and exit
    ...
    --query-sop-classes <file|url>      file path or URL of list of
                                        ...
                                        ies by default
    --raccoon <file>                    file path of raccoon config json (required)
 ...
 -V,--version                           output version information and
                                        exit
-
Example: dcmqrscp -b DCMQRSCP:11112 --dicomdir /media/cdrom/DICOMDIR --raccoon ./resources/raccoon-app.json
